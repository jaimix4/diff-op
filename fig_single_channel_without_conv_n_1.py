...
# ==========================================
# 3. REGIONAL OPTIMIZATION (N=1: One single region over the whole domain)
# ==========================================
# Set up a single optimization region spanning from rho.min() to rho.max()
edges = np.array([rho.min(), rho.max()])
...
# --- PANEL 1: Parameters ---
# Plotted together on a single unified y-axis
...
axs[0].set_title(r"Sinc Operator Electron Channel without Convection, $N_{regions}=1$")
...
plt.savefig("single_channel_without_conv_N1.png", dpi=300, bbox_inches='tight')
plt.show()